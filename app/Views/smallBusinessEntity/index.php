          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Реестр СМП</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                    <a href="<?= route_to('small.business.entity.new') ?>" class="btn btn-success mb-3 mr-2">+ Добавить</a>  
                    <div class="col-md-8">
                        <div class="form-group">
                            <select id="action" class="form-control select2" style="width: 100%;" disabled>
                                <option value="" selected>Выберите действие</option>
                                <option value="<?= base_url('small-business-entity/edit') ?>">Редактировать</option>
                                <option value="<?= base_url('small-business-entity/delete') ?>">Удалить</option>
                            </select>
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?= $item ?></td>
                    <td><?= $smallBusinessEntity['title'] ?></td>
                    <td>
                        <div class="icheck-primary d-inline">
                            <input type="radio" class="radio-group" id="radioPrimary<?= $smallBusinessEntity['id'] ?>" name="r" value="<?= $smallBusinessEntity['id'] ?>">
                            <label for="radioPrimary<?= $smallBusinessEntity['id'] ?>">
                            </label>
                        </div>
                    </td>
                  </tr>
