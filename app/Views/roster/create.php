        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    ?>
                        <form action="<?= route_to('roster.create') ?>" method="post" >
                        <?= csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Выберите СМП *</label>
                                        <select class="form-control <?= add_error_class($errors_data, 'small_business_entity_id'); ?> select2" name="small_business_entity_id" style="width: 100%;" data-placeholder="Выберите СМП">
                                        <option></option>
                                        <?php foreach ($smallBusinessEnties as $smallBusinessEntity): ?>
                                            <?php if ($smallBusinessEntity['id'] == old('small_business_entity_id')): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="from" data-target-input="nearest">
                                            <input type="text" name="planned_verification_period_from" class="form-control <?= add_error_class($errors_data, 'planned_verification_period_from'); ?> datetimepicker-input" data-target="#from" value="<?= old('planned_verification_period_from'); ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="before" data-target-input="nearest">
                                            <input type="text" name="planned_verification_period_before" class="form-control <?= add_error_class($errors_data, 'planned_verification_period_before'); ?> datetimepicker-input" data-target="#before" value="<?= old('planned_verification_period_before'); ?>" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?= add_error_class($errors_data, 'supervisory_authority_id'); ?> select2" name="supervisory_authority_id" style="width: 100%;" data-placeholder="Выберите контролирующий орган">
                                        <option></option>
                                        <?php foreach ($supervisoryAuthorities as $supervisoryAuthority): ?>
                                            <?php if ($supervisoryAuthority['id'] == old('supervisory_authority_id')): ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="input" name="planned_duration_check" class="form-control <?= add_error_class($errors_data, 'planned_duration_check'); ?>" placeholder="Длительность проверки" value="<?= old('planned_duration_check'); ?>">
